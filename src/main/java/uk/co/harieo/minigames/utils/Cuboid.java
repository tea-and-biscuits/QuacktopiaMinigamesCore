...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	...
	public Cuboid(Location l1, Location l2) {
		if (l1.getWorld() == null || l2.getWorld() == null) {
			throw new NullPointerException("Location doesn't provide world");
	...
	public boolean contains(Location l) {
		return worldName.equals(Objects.requireNonNull(l.getWorld()).getName()) && contains(l.getBlockX(),
	...
	/**
	 * Contract the Cuboid, returning a Cuboid with any air around the edges removed, just large enough to include all
	 * non-air blocks.
	 *
	...
	/**
	 * Contract the Cuboid in the given direction, returning a new Cuboid which has no exterior empty space. E.g. a
	 * direction of Down will push the top face downwards as much as possible.
	 *
